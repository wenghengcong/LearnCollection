...
void sm_before_objc_msgSend(id self, SEL _cmd, uintptr_t lr) {
    push_call_record(self, object_getClass(self), _cmd, lr);
}

uintptr_t sm_after_objc_msgSend() {
...
static void hook_Objc_msgSend() {
    ...
    call(blr, &sm_before_objc_msgSend)
    ...
    // Call our sm_after_objc_msgSend.
    call(blr, &sm_after_objc_msgSend)
