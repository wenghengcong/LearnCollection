...
{
    UIAlertView *alert = [[UIAlertView alloc]initWithTitle:title message:message delegate:delegate cancelButtonTitle:cancelTitle otherButtonTitles:nil];
    return alert;
}

+ (UIAlertView *)alertViewWithTitle:(NSString *)title Message:(NSString *)message Delegate:(id)delegate
{
    return [self alertViewWithTitle:title Message:message Delegate:delegate cancelButtonTitle:@"确定"];
}

+ (UIAlertView *)alertViewWithTitle:(NSString *)title Message:(NSString *)message
{
    return [self alertViewWithTitle:title Message:message Delegate:nil cancelButtonTitle:@"确定"];
}

+ (UIAlertView *)alertViewWithTitle:(NSString *)title
{
    return [self alertViewWithTitle:title Message:nil Delegate:nil cancelButtonTitle:@"确定"];
}
